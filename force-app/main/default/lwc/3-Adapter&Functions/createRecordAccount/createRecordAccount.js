...
export default class CreateRecordAccount extends LightningElement {
    ...
    changeHandler(event){
        ...
        // this.formData.name = value; // yanlis yol. nokta ile ulasilamaz.
        this.formData[name] = value; // bu satir yukaridaki gibi formData olusturur. field name ile bakar eger field de bir deger varsa forma ekler. 
    ...
    saveAccount(){
        ...
        const revenue = Number(this.formData.AnnualRevenue); // forma yazilan string ifadeyi number a cevir
        if(revenue >= 1000000){
