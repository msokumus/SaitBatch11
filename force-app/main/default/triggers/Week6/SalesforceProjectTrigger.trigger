trigger SalesforceProjectTrigger on Salesforce_Project__c (before insert, after insert, before update, after update) {
    ...
    if (Trigger.isBefore && trigger.isUpdate) {
        ...
        //SalesforceProjectTriggerHandler.completeSPvalidation(Trigger.New, Trigger.Old, Trigger.NewMap, Trigger.OldMap); // bunu devre disi biraktik. asagidaki calissin diye
    }
